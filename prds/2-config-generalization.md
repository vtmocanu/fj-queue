...
**Priority**: Medium
**Status**: Not started. Generalizes the tool (whose initial implementation and Prometheus/NCPS metrics already shipped) for public consumption.
