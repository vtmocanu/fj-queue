...
def _unicode_snap():
    ...
    return _snap(
        runners=runners,
        jobs=jobs,
        repo_names={1: "owner-c/test-repo", 2: "owner-c/cafe"},
    )
...
def test_plain_renders_wide_chars_and_emoji_without_crash():
    ...
    assert "owner-c/test-repo" in out
    assert "owner-c/cafe" in out
